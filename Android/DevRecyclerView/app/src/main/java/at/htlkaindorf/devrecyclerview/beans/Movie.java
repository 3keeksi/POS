package at.htlkaindorf.devrecyclerview.beans;
...
public class Movie {
    ...
    private static final DateTimeFormatter DTF = DateTimeFormatter.ofPattern("MMM uuuu");
    ...
    public String getRelasedString() {
